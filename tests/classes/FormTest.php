...
class FormTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$this->assertEquals(
			'<select id="name" name="name" class=""><option label="one" value="1">one</option><option label="two" value="2">two</option><option label="three" value="3">three</option></select>',
	...
	{
		$this->assertRegExp(
			'/^<select id="state" name="state" class=""><option label="-- Select State --" value="">-- Select State --<\/option>(<option label=".+" value="[A-Z]{2}">.+<\/option>)+<\/select>$/',
	...
	{
		$this->assertEquals(
			'<select id="date[month]" name="date[month]" class=""><option label="Month" value="">Month</option><option label="January" value="01">January</option><option label="February" value="02">February</option><option label="March" value="03">March</option><option label="April" value="04">April</option><option label="May" value="05">May</option><option label="June" value="06">June</option><option label="July" value="07">July</option><option label="August" value="08">August</option><option label="September" value="09">September</option><option label="October" value="10">October</option><option label="November" value="11">November</option><option label="December" value="12">December</option></select> <select id="date[day]" name="date[day]" class=""><option label="Day" value="">Day</option><option label="1" value="01">1</option><option label="2" value="02">2</option><option label="3" value="03">3</option><option label="4" value="04">4</option><option label="5" value="05">5</option><option label="6" value="06">6</option><option label="7" value="07">7</option><option label="8" value="08">8</option><option label="9" value="09">9</option><option label="10" value="10">10</option><option label="11" value="11">11</option><option label="12" value="12">12</option><option label="13" value="13">13</option><option label="14" value="14">14</option><option label="15" value="15">15</option><option label="16" value="16">16</option><option label="17" value="17">17</option><option label="18" value="18">18</option><option label="19" value="19">19</option><option label="20" value="20">20</option><option label="21" value="21">21</option><option label="22" value="22">22</option><option label="23" value="23">23</option><option label="24" value="24">24</option><option label="25" value="25">25</option><option label="26" value="26">26</option><option label="27" value="27">27</option><option label="28" value="28">28</option><option label="29" value="29">29</option><option label="30" value="30">30</option><option label="31" value="31">31</option></select> <select id="date[year]" name="date[year]" class=""><option label="Year" value="">Year</option></select>',
	...
	{
		$this->assertEquals(
			'<select id="decision" name="decision" class=""><option label="Yes" value="1">Yes</option><option label="No" value="0" selected="selected">No</option></select>',
